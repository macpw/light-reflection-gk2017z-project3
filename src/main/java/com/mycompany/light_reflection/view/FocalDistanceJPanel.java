...
public final class FocalDistanceJPanel extends JPanel {
    ...
    public FocalDistanceJPanel() {
        this.focalDistanceJSlider.setMaximum(maximumValue);
        this.focalDistanceJSlider.setMinorTickSpacing(maximumValue/40);
        this.focalDistanceJSlider.setMajorTickSpacing(maximumValue/10);
    ...
    public static void main(String[] args) {
        ...
        FocalDistanceJPanel focalDistanceJPanel = new FocalDistanceJPanel();
        mainJPanel.add(focalDistanceJPanel);
